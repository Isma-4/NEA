...
class Game(): #Game class acts as framework for the game
    ...
    def init_objects(self): #Initialise objects
        #Player
        self.player = Player(self,10*TILESIZE,6*TILESIZE)
    ...
    def init_object_status(self): #Initialise the default status of objects
        ...
        self.button_status =     [0,0,0,0,0,True,0,0,0,0,0,0,0,0,0] #List to hold status of all buttons, starting with default
        self.item_collected =    [True,0,True,0,0,0,0,0,0,0,0] #List to hold boolean values whether an in game item has been collected
    ...
    def new_room(self, roomx, roomy): #Initalise the animated tiles and objects for all rooms
        ...
        if roomx == 1 and roomy == 3: #ROOM 1 3
            self.slime = Enemy(self, "slime", roomx, roomy, TILESIZE*11, TILESIZE*7, 1, 0.005, 0.05)
        ...
        for itile in self.interacttile_sg:
            if pg.sprite.collide_rect(self.player, itile):
                ...
                if self.roomx == 0 and self.roomy == 2: #--------------------------------------------------------
                    ...
                    elif self.player.x == TILESIZE*10 and self.phase == 3: #Janitor in position 2
                        if not self.item_collected[2]:
